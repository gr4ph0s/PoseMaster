...
class CommandLuncher(c4d.plugins.CommandData):
    ...
    def register(self):
        ...
        flags = 0
        icon = None
        help = "Pose Library for Cinema 4D"
        return c4d.plugins.RegisterCommandPlugin(
            Const.PLUGIN_ID, "Pose Master v{}".format(Const.VERSION), flags, icon, help, self)

    def Execute(self, doc):
        return self.dialog.Open(c4d.DLG_TYPE_ASYNC, Const.PLUGIN_ID, defaultw=100, defaulth=100)
